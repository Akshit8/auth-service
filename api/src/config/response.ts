...
export const message: { [index: string]: string } = {
    ...
    userAlreadyExistsName: 'User already exists with that username',
    userAlreadyExistsMail: 'User already exists with that email',
    userAlreadyExistsPhoneNumber: 'User already exists with that phone-number',
    userAlreadyExistsID: 'User already exists with that id',
    userAlreadyExistsAadharNo: 'User already exists with that aadharNumber',
    ...
    usernameNotMatchPassword: 'username and password do not match'
};
